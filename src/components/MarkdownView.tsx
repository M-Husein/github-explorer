...
export const MarkdownView = ({
  ...
  const blockquote = ({ node, className, ...props }: any) => (
    <blockquote {...props} className={cn("blockquote", className, blockquoteClass)} />
  );
  ...
  const iframe = ({ node, className, width, height, ...props }: any) => (
    <iframe
      {...props}
      className={cn("aspect-video w-full", className, iframeClass)}
    />
  );
  ...
  const p = ({ node, align, className, ...props }: any) => (
    <p
      {...props}
      className={cn(align === 'center' && 'text-center', className, paragraphClass)}
    />
  );
